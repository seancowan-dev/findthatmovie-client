...
describe('| UserLists Test Object |', () => {
  it('should render correctly in "debug" mode', () => {
    const component = shallow(<Provider {...store}><UserLists debug /></Provider>);
    expect(component).toMatchSnapshot();
  });
  it('should render correctly in "production" mode', () => {
    const component = shallow(<Provider {...store}><UserLists production /></Provider>);
    expect(component).toMatchSnapshot();
  });
});